...
RUN git clone https://github.com/swatv3nub/HackfreaksTelethonUserbot /root/HackfreaksUserbot
RUN mkdir /root/HackfreaksUserbot/bin/
WORKDIR /root/HackfreaksUserbot/
