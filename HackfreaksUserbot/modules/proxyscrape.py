...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern="http$"))
@Hackfreaks.on(sudo_cmd(pattern="http$", allow_sudo=True))
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern="socks4$"))
@Hackfreaks.on(Hackfreaks_on_cmd(pattern="socks4$", allow_sudo=True))
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern="socks5$"))
@Hackfreaks.on(Hackfreaks_on_cmd(pattern="socks5$", allow_sudo=True))
async def Hackfreaks(event):
    await event.get_chat()
