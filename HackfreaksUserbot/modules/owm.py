...
from HackfreaksUserbot import OPEN_WEATHER_MAP_APPID as OWM_API
from HackfreaksUserbot.events import errors_handler, register
...
async def set_default_city(city):
    """ For .ctime command, change the default HackfreaksUserbot country for date and time commands. """
