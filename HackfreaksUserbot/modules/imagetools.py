...
from HackfreaksUserbot.functions import convert_to_image, crop_vid, runcmd
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"cit"))
@Hackfreaks.on(sudo_cmd(pattern=r"cit", allow_sudo=True))
async def hmm(event):
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"nst"))
@Hackfreaks.on(sudo_cmd(pattern=r"nst", allow_sudo=True))
async def hmm(event):
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"thug"))
@Hackfreaks.on(sudo_cmd(pattern=r"thug", allow_sudo=True))
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"tni"))
@Hackfreaks.on(sudo_cmd(pattern=r"tni", allow_sudo=True))
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"tig"))
@Hackfreaks.on(sudo_cmd(pattern=r"tig", allow_sudo=True))
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"jail"))
@Hackfreaks.on(sudo_cmd(pattern=r"jail", allow_sudo=True))
async def hmm(event):
    if not event.reply_to_msg_id:
        await event.reply("Reply to any Image.")
        return
    ...
    background.save("./Hackfreaks/testing.png")

    file_name = "testing.png"
    ok = "./Hackfreaks/" + file_name
    await borg.send_file(event.chat_id, ok)
    await hmmu.delete()
    for files in (ok, img):
        if files and os.path.exists(files):
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"greyscale"))
@Hackfreaks.on(sudo_cmd(pattern=r"greyscale", allow_sudo=True))
async def hmm(event):
    if not event.reply_to_msg_id:
        await event.reply("Reply to any Image.")
        return
    ...
    cv2.imwrite("./Hackfreaks/testing.png", gray_img)
    file_name = "testing.png"
    ok = "./Hackfreaks/" + file_name
    await borg.send_file(event.chat_id, ok)
    await hmmu.delete()
...
# TG ~>>//@CharonCB21
# @code-rgb
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"fgs ?(.*)"))
@Hackfreaks.on(sudo_cmd(pattern=r"fgs ?(.*)", allow_sudo=True))
async def img(event):
    ...
    photo.save(ok)
    await event.delete()
    await Hackfreaks.send_file(event.chat_id, ok)
    if os.path.exists(ok):
        os.remove(ok)


@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"lg"))
@Hackfreaks.on(sudo_cmd(pattern=r"lg", allow_sudo=True))
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"ph ?(.*)"))
@Hackfreaks.on(sudo_cmd(pattern=r"ph ?(.*)", allow_sudo=True))
async def img(event):
    text = event.pattern_match.group(1)
    if not text:
    ...
    img.save("./Hackfreaks/testpb.jpg")
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"spin ?(.*)"))
@Hackfreaks.on(sudo_cmd(pattern=r"spin ?(.*)", allow_sudo=True))
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern=r"lnews ?(.*)"))
@Hackfreaks.on(sudo_cmd(pattern=r"lnews ?(.*)", allow_sudo=True))
async def hmm(event):
    text = event.pattern_match.group(1)
    if not text:
    ...
    im.save("./Hackfreaks/livenews.png")
