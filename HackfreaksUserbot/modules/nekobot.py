...
@Hackfreaks.on(Hackfreaks_on_cmd("ttt ?(.*)"))
@Hackfreaks.on(sudo_cmd("ttt ?(.*)", allow_sudo=True))
...
@Hackfreaks.on(Hackfreaks_on_cmd("tweet ?(.*)"))
@Hackfreaks.on(sudo_cmd("tweet ?(.*)", allow_sudo=True))
async def noobishere(event):
    reply_to_id = event.message.id
