...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern="imp(|n) (.*)", outgoing=True))
@Hackfreaks.on(sudo_cmd(pattern="imp(|n) (.*)", allow_sudo=True))
async def _(event):
    kraken = bot.uid
...
@Hackfreaks.on(Hackfreaks_on_cmd(pattern="timp(|n) (.*)", outgoing=True))
@Hackfreaks.on(sudo_cmd(pattern="timp(|n) (.*)", allow_sudo=True))
async def _(event):
    name = event.pattern_match.group(2)
    cmd = event.pattern_match.group(1).lower()
